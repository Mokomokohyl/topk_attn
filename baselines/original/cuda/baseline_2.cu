...
//   make s2
// Or manual:
//   nvcc -O3 -std=c++17 -arch=sm_120a -o bin/baseline_2 baselines/original/cuda/baseline_2.cu && ./bin/baseline_2
...
int main(int argc, char** argv) {
    ...
    std::vector<half> h_out(HEAD_NUM * HEAD_DIM), h_out_fused(HEAD_NUM * HEAD_DIM);
    ...
    printf("---- Baseline 2 latency test ----\n");
