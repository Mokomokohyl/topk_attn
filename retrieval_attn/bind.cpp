...
void retrieval_attention_pipelined_global_32(
    torch::Tensor query,
    torch::Tensor key_cache,
    torch::Tensor value_cache,
    torch::Tensor output
    ...
    int batch_size = query.size(0);
    launch_retrieval_attention_pipelined_global_32(
        reinterpret_cast<const half*>(query.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(key_cache.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(value_cache.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
void retrieval_attention_pipelined_global_128(
    torch::Tensor query,
    torch::Tensor key_cache,
    torch::Tensor value_cache,
    torch::Tensor output
    ...
    int batch_size = query.size(0);
    launch_retrieval_attention_pipelined_global_128(
        reinterpret_cast<const half*>(query.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(key_cache.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(value_cache.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
void retrieval_attention_pipelined_global_256(
    torch::Tensor query,
    torch::Tensor key_cache,
    torch::Tensor value_cache,
    torch::Tensor output
    ...
    int batch_size = query.size(0);
    launch_retrieval_attention_pipelined_global_256(
        reinterpret_cast<const half*>(query.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(key_cache.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(value_cache.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
void retrieval_attention_pipelined_global_512(
    torch::Tensor query,
    torch::Tensor key_cache,
    torch::Tensor value_cache,
    torch::Tensor output
    ...
    int batch_size = query.size(0);
    launch_retrieval_attention_pipelined_global_512(
        reinterpret_cast<const half*>(query.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(key_cache.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(value_cache.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
void retrieval_attention_pipelined_global_1024(
    torch::Tensor query,
    torch::Tensor key_cache,
    torch::Tensor value_cache,
    torch::Tensor output
    ...
    int batch_size = query.size(0);
    launch_retrieval_attention_pipelined_global_1024(
        reinterpret_cast<const half*>(query.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(key_cache.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(value_cache.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("retrieval_attention_pipelined_global_32", &retrieval_attention_pipelined_global_32, "Pipelined Retrieval Attention (TopK=32)");
    m.def("retrieval_attention_pipelined_global_128", &retrieval_attention_pipelined_global_128, "Pipelined Retrieval Attention (TopK=128)");
    m.def("retrieval_attention_pipelined_global_256", &retrieval_attention_pipelined_global_256, "Pipelined Retrieval Attention (TopK=256)");
    m.def("retrieval_attention_pipelined_global_512", &retrieval_attention_pipelined_global_512, "Pipelined Retrieval Attention (TopK=512)");
    m.def("retrieval_attention_pipelined_global_1024", &retrieval_attention_pipelined_global_1024, "Pipelined Retrieval Attention (TopK=1024)");
